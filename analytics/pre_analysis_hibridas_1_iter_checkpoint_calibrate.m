...
beta_lb_up_op = [1e-1,0.4]; % Mayoria de valores cercanos a 0.2
gamma_lb_up_op = [1e-4,1e-2]; % % (1/gamma) tiempo de infección promedio - tasa de remosión media
...
options6 = optimoptions("ga",'UseParallel', true,'UseVectorized', false,'CreationFcn',{ @gacreationnonlinearfeasible,'UseParallel',true,'NumStartPts',20}, ...
