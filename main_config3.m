...
%% ------------------------
%global all_taus; % en caso de modelar primera ola se usan diferentes taus
...
contF=1
funEvals = 20000;
%Mv(funEvals) = struct('cdata',[],'colormap',[]);
...
% pre_config_1
% callProcessing
nCiclos = 2% veces que se reduce beta a la mitad
