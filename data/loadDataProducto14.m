...
ftable=0;
fdouble=0;
pData = strcat(pathDATA,'\producto14\FallecidosCumulativo.csv')
[fstring,ftable,fdouble] = D14(pData);

%% I-Covid
    dataTable = ftable(string(ftable.Region)==regionA, :);
    T=dataTable;
    rowsIndex = ftable.('Region')==regionA;
    dataDouble = fdouble(rowsIndex,:);
